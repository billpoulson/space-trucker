import { AppPermission, Role, UserInfoObject } from '@space-truckers/types'

export abstract class RBACContainerBase<TRoles, TResource, TAction> {
...
export abstract class RBACUserContainerBase<TRole, TResource, TAction> {
  role: TRole
